...
mat4 Engine::Game::GetDefaultProjection()
{
	return defaultProjection;
}

Shader* Engine::Game::GetDefaultSpriteShader()
{
	return defaultSpriteShader;
}

Shader* Engine::Game::GetDefaultTextShader()
{
	return defaultTextShader;
}

Quad* Engine::Game::GetDefaultQuad()
{
	return defaultQuad;
}

Input* Engine::Game::GetInputManager()
{
	return inputManager;
}

Setting* Engine::Game::GetSettings()
{
	return setting;
}
...
{
	return  (new Shader("sprite.vert", "sprite.frag"))->Use()->setMat4(defaultProjection, "projection");
}

Shader* Engine::Game::CreateDefaultTextShader()
{
	return  (new Shader("text.vert", "text.frag"))->Use()->setMat4(defaultProjection, "projection");
}
...
State Engine::Game::GetState()
{
	return state;
}

void Engine::Game::SetState(State state)
{
	this->state = state;
}
